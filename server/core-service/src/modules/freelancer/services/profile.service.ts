...
import { Freelancer } from "../../../generated/prisma";
import { UpdateProfileData, PublicFreelancerProfile } from "../interfaces/freelancer.interfaces";
...
export const ProfileService = {
  ...
  getPublicFreelancerProfile: async (userId: string): Promise<PublicFreelancerProfile> => {
    ...
    return {
      ...
      skills: user.Freelancer.skills.map(skill => skill.name),
